...
In Kapitel 1 werden die Datenmodelle der relationale und NoSQL Datenbanken vorgestellt. Als Untergruppe der NoSQL Datenbanken werden die Graphdatenbanken erläutert, zu welcher das vorgestellte System Neo4j gehört. \newline
 In Kapitel 2 , wird eine Definition für die Datenstruktur Graph dargelegt und es wird beschrieben wie diese in Neo4j verwendet wird. Es wird ein Überblick von den zur Verfügung stehenden Features und die grundlegende Architektur gegeben. Anschließend werden die einzelnen Bestandteile der Architektur, die zusammen das Datenbank Management System bilden, genauer beschrieben. Abschließend wird auf die Modi eingegangen, in den Neo4j bedient werden kann. \newline
Das Kapitel 3  beschreibt den verwendeten Datensatz und stellt eine Kategorisierung für Anfragen vor. Aufbauend auf diesen Kategorien, werden 3 Testläufe vorgestellt, welche aus mehreren Anfragen bestehen. Es werden verschiedene Aspekte bei den Anfragen betrachtet und es werden Vermutungen über das Verhalten der Anfragen aufgestellt.  \newline
Für Kapitel 4 werden alle Anfrage aus Kapitel 3 ausgeführt und die Ergebnisse werden tabellarisch aufgeführt. Mit Hilfe der Ergebnisse folgt eine Überprüfung der aus Kapitel 3 aufgestellten Hypothesen. Es wird gezeigt, wie sich Umformulierungen der Anfragen auf die Performanz ausübt und dass alle Anfragen in der Core API schneller ausgeführt werden als in Cypher. Ein Vergleich von Neoj4 und OrientDB zeigt, dass Neo4j alle gestellten Anfragen schneller bearbeiten kann.  Anschließend wird ein praktisches Anwendungsszenario für Neo4j beschrieben. Aufbauend auf den erfassten Erkenntnissen wird eine Bewertung von Neo4j getroffen und es werden Limitierungen und zukünftige Arbeiten zu den Testläufen aufgelistet.
\end{abstract}
