...
\supervisor{Felix Kühr & Tanya Braun \textsc{Smith}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\begin{titlepage}
	...
	\vskip 44pt
		...
		\textbf{Felix Kühr und Tanya Braun}
		\vfill
		Lübeck, den \today
		\vskip 20pt
		Im Focus das Leben
