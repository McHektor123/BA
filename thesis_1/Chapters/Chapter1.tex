...
\newline
\newline
Wenn der Nutzer mit der Struktur der Daten in dem Graph vertraut ist, kann das ausgewählte eine erheblichen Performanz-Unterschied  hervorbringen \parencite{vukotic2015neo4j}. Die Traversion kann auch bidirektional aufgeführt werden, dabei werden 2 Anfangsknoten angeben und die Suche wird so lange ausgeführt, bis es zu einer Kollision der beiden Pfade kommt. Wenn eine Kollision zwischen den beiden Pfaden erkannt wird, ist damit zum Beispiel eine Verbindung der beiden Knoten bewiesen.
