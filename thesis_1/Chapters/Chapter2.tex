...
\section{Erste Interation}
Die erste Iteration besteht primär aus direkten Nachbarschafts-Anfragen und Zusammenfassungen. Von folgenden Grundanfragen werden mehrere Permutationen gebildet und diese werden miteinander verglichen. \newline \newline
...
RETURN COUNT(DISTINCT(p1))
\end{Verbatim} 
Diese Anfrage findet die Anzahl aller Verbindungen über die Relation RELATIONSHIP3 mit der exakten Tiefe 2. Es handelt sich um eine Nachbarschafts-Anfrage. Diese Grundanfrage erneut wird mit der Tiefe 3 ausgeführt und beide Anfragen werden in den APIs mit der Depth-First-Methode und Depth-First-Methode ausgeführt. 
