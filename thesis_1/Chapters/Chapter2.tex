...
\begin{enumerate}
	...
	\item Der relative Anteil an erreichten Personen
\end{enumerate}
...
Für \textbf{Grundanfrage 2.3} werden folgende Aspekte betrachet: 
\begin{enumerate}
...
Zum 2. Aspekt: Ausgehend von der Annahme,dass der Algorithmus für den Compiler optimiert ist, wird der Anfrage mit dem Algorithmus ein schneller Ausführungszeit aufweisen.
