...
\begin{table}[h]
	...
	\begin{tabular}{ |p{5cm}||p{5cm}|p{3cm}  }
		...
		Anfrage& Name\\
		\hline
		Grundanfrage 2.4.1 &  Cypher - Tiefensuche\\
		Vergleichsanfrage 1 &  Einseitig - Tiefensuche \\
		Grundanfrage 2.4.2 &  Einseitig Breitensuche\\
		Grundanfrage 2.4.3&  Bidirektional - Breitensuche\\
		Grundanfrage 2.4.4 &  Bidirektional - Tiefensuche\\
		\hline
	\end{tabular}
