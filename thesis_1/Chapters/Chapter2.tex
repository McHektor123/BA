...
\end{enumerate}
Einer Anfrage können mehrere Kategorien zugeordnet werden. Das Experiment ermittelt, ob in Neo4j eine Korrelation zwischen Kategorie und Performanz einer Anfrage besteht. Hierfür werden 3 Testläufen durchgeführt, in denen eine Menge von Anfragen gestellt und analysiert werden. 
...
\end{enumerate}
Zum 1. Aspekt: Zwischen den Anfragen wird ein kleiner Unterschied bestehen, da der Optimierer eine der beiden Ausdrücke in den anderen überführen wird und der Optimierer selbst Ressourcen beansprucht. \newline
