...
\end{Verbatim}
 \textbf{Grundanfrage 2.4} wir ausschließlich in der Core API formuliert. \newline
Die Anfrage traversiert über den gesamten Graphen. Diese Anfrage wird mit der Breath-First- und Depth-First-Search formuliert und   wird zusätzlich mit der Bidirektionalen Traversierung bearbeitet. Es ergeben sich 4 Anfrage. 
